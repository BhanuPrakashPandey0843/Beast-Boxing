    ...
    <div className="bg-gray-50 min-h-screen flex flex-col justify-center items-center py-12">
      ...
      <div className="relative flex justify-center items-center">
        ...
        <button
          ...
          className="absolute left-0 rounded-full p-2 bg-black text-white shadow-md hover:bg-gray-800 transition duration-300 ease-in-out"
        ...
        {/* Testimonial Card add some shades of color */}
        <div className="bg-white shadow-lg rounded-lg p-6 md:p-10 flex flex-col justify-between items-center text-center transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl h-72 md:h-80">
          <img
            className="w-16 h-16 rounded-full border-4 border-white shadow-lg mb-4"
            src={testimonials[currentIndex].image}
            alt={`${testimonials[currentIndex].name}'s profile`}
          />
          <p className="text-gray-600 mb-4 flex-grow text-lg md:text-xl">{testimonials[currentIndex].text}</p>
          <h3 className="font-bold text-lg text-gray-800">{testimonials[currentIndex].name}</h3>
        ...
        <button
          ...
          className="absolute right-0 rounded-full p-2 bg-black text-white shadow-md hover:bg-gray-800 transition duration-300 ease-in-out"
